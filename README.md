...
| `superclusters/blackhole/SC24_32x4_revAB_subtorus_virtu/` | 24 | Virtu SC24, subtorus connectivity, `bg-ale22` host series; shared by the full SC24 mapping and the SC20 decode-subset mapping (nodes 5–24) |
